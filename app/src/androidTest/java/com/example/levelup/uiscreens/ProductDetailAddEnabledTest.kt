...
class ProductDetailAddEnabledTest {
    @get:Rule
    val compose = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun add_button_enabled_when_in_stock() = runTest(UnconfinedTestDispatcher()) {
        ...
        val product = ProductDTO(61L, "Mouse Pro", "Óptico", 80, "/img", "peripherals", 5)
        coEvery { productRepo.getProductById(61L) } returns product
        ...
        compose.onNodeWithText("AGREGAR AL CARRITO").assertIsEnabled()
    }
}
